...
console.log("Today is " + weather.forecast.one.day + ". The high is " + weather.forecast.one.high + ". It will be " + weather.forecast.one.text + ".");
console.log("Today is " + weather.forecast.two.day + ". The high is " + weather.forecast.two.high + ". It will be " + weather.forecast.two.text + ".");
console.log("Today is " + weather.forecast.three.day + ". The high is " + weather.forecast.three.high + ". It will be " + weather.forecast.three.text + ".");
